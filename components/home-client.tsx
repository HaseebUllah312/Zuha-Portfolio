        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            >
              ...
              <h6 className="text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold tracking-tighter">Systems Defense | Forensics Enthusiast | IT Student</h6>
              <p className="text-lg md:text-xl text-muted-foreground max-w-[600px] mx-auto lg:mx-0">
                Hello! I&apos;m Zuha Riaz, a Cyber Security Analyst and IT student at Punjab University. I specialize in network security monitoring, threat detection labs, digital forensics, and proactive endpoint defense systems.
              </p>
              <motion.div 
              ...
              >
                ...
                <Button size="lg" variant="outline" asChild>
                  <Link href="mailto:zuha25673@gmail.com">Contact Me</Link>
                </Button>
              </motion.div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <div className="absolute inset-0 rounded-full bg-purple-500/20 blur-[60px] animate-pulse" />
              
              {/* Outer Decorative Ring */}
              <div className="absolute inset-[-15px] rounded-full border border-purple-500/30 animate-[spin_10s_linear_infinite]" />
              <div className="absolute inset-[-15px] rounded-full border-t-2 border-l-2 border-purple-500 opacity-40 animate-[spin_6s_linear_infinite]" />

              {/* Main Circular Container with Fuchsia Gradient Border */}
              <div className="relative w-full h-full rounded-full p-1.5 sm:p-2.5 bg-gradient-to-tr from-[#7c3aed] via-[#d946ef] to-[#f472b6] shadow-[0_0_40px_rgba(217,70,239,0.4)] overflow-visible">
              ...
              <motion.div 
                className="absolute -top-4 -right-4 bg-background/80 backdrop-blur-md border border-purple-500/50 px-4 py-2 rounded-full shadow-lg text-xs font-bold text-purple-600 dark:text-purple-300"
              ...
              <motion.div 
                className="absolute -bottom-2 -left-6 bg-background/80 backdrop-blur-md border border-purple-500/50 px-4 py-2 rounded-full shadow-lg text-xs font-bold text-purple-600 dark:text-purple-300"
                initial={{ x: -20, opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
        ...
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <p className="text-muted-foreground md:text-lg max-w-[800px] mx-auto px-4">
              Expertise in Penetration Testing, Incident Response, SIEM Deployment, and Digital Forensics.
            </p>
          </motion.div>
          <ToolsGrid />
        ...
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <p className="mx-auto max-w-[600px] text-muted-foreground md:text-lg mt-4">
              Ready to secure your digital infrastructure? Let&apos;s collaborate on your next security audit or network defense lab.
            </p>
